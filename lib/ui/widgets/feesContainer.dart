...
class FeesContainer extends StatefulWidget {
  ...
  FeesContainer({Key? key, this.childId}) : super(key: key);
...
class _FeesContainerState extends State<FeesContainer> {
  late ScrollController _scrollController = ScrollController()
    ..addListener(_feesScrollListener);
  ...
  @override
  void dispose() {
    _scrollController.removeListener(_feesScrollListener);

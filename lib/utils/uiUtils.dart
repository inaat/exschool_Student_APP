...
import 'package:exschool/cubits/downloadFileCubit.dart';
import 'package:exschool/data/models/studyMaterial.dart';
import 'package:exschool/data/repositories/subjectRepository.dart';
import 'package:exschool/ui/widgets/downloadFileBottomsheetContainer.dart';
import 'package:exschool/ui/widgets/errorMessageOverlayContainer.dart';
...
class UiUtils {
  //This extra padding will add to MediaQuery.of(context).padding.top in order give same top padding in every screen
  ...
  static Duration showCaseDisplayDelayInDuration =
      const Duration(milliseconds: 1); //350;

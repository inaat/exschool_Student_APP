import 'package:exschool/data/models/academicYear.dart';
import 'package:exschool/data/models/attendanceDay.dart';
import 'package:exschool/data/models/coreSubject.dart';
import 'package:exschool/data/models/electiveSubject.dart';
import 'package:exschool/data/models/exam.dart';
import 'package:exschool/data/models/parent.dart';
import 'package:exschool/data/models/result.dart';
import 'package:exschool/data/models/timeTableSlot.dart';
...
/*        "totalPage": result['data']['last_page'] ?? 1,
  ...
  Future<List<ExamTimeTable>> fetchExamTimeTable(
    ...
    try {
      Map<String, dynamic> queryParameters = {"exam_id": examId};
      if (useParentApi) {
        queryParameters.addAll({"child_id": childId});
      }
      final result = await Api.get(
